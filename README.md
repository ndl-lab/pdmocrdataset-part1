...
国立国会図書館（以下、「当館」といいます。）がLINE株式会社に委託して実施した「[令和3年度デジタル化資料のOCRテキスト化](https://lab.ndl.go.jp/data_set/ocr/r3_line/)」事業の成果物を公開するリポジトリです。


## 概要
テキスト化性能の改善を目的として当館の保有するデジタル化資料から作成したOCR学習用途の機械学習データセットのうち、
